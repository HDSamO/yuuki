  ...
  try {
    ...
    if (firebaseUser != null) {
      ...
      if (documentSnapshot.exists) {
        ...
        return UserResult(success: false, errorMessage: "User document not found");
      }
    } else {
      // Handle failed user creation with Firebase Authentication
      return UserResult(success: false, errorMessage: "Failed to create user with Firebase Authentication");
    }
...
Future<PasswordResult> changePassword(String newPassword) async {
  ...
  if (user != null) {
    ...
    return PasswordResult(success: false, errorMessage: "User is not authenticated");
  }
}
